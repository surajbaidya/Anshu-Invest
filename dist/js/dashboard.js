...
/* js for doughnut chart suraj */
  window.onload = function () {
    ...
    window.onload = function () {
      ...
      var chart = new CanvasJS.Chart("portfolio", {
        animationEnabled: true,
      ...
      var chart = new CanvasJS.Chart("sector-chart", {
        animationEnabled: true,
  ...
  /* heigh chart for dashboard of analysis chart */

/* high chart bar diagram of dashboard */
Highcharts.chart('analysisBar', {
  chart: {
    type: 'column',
    backgroundColor: '#F8FAFF',
